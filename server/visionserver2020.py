...
class VisionServer2020(VisionServer):
    ...
    rrtarget_hue_low_limit = ntproperty('/SmartDashboard/vision/rrtarget/hue_low_limit', 55,
    ...
    rrtarget_value_low_limit = ntproperty('/SmartDashboard/vision/rrtarget/value_low_limit', 55,
    ...
    def __init__(self, calib_string, test_mode=False):
        super().__init__(initial_mode='goalfinder', test_mode=test_mode)
