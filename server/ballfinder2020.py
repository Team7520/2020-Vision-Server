...
class BallFinder2020(GenericFinder):
    ...
    def __init__(self, calib_string):
        ...
        self.low_limit_hsv = numpy.array((20, 140, 110), dtype=numpy.uint8)
        self.high_limit_hsv = numpy.array((32, 255, 255), dtype=numpy.uint8)
    ...
    def process_image_simple(self, camera_frame):
        ...
        for c in contours:
            ...
            if radius > 8:
                ...
                distance = (48 + 3.5) * 25.88 / radius - 3.5
    ...
    def process_image(self, camera_frame):
        '''Main image processing routine'''
        # return self.process_image_simple(camera_frame)
