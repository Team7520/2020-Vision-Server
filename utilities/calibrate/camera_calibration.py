...
if __name__ == '__main__':
    ...
    parser.add_argument('--length', '-l', type=int, default=8, help='Length of checkerboard (number of corners)')
    ...
    parser.add_argument('--output-images', nargs=1, default='output', help="Save processed images to directory")
    parser.add_argument('--input', '-d', default='calibration', help='folder has image files')
    ...
    ret, mtx, dist, rvecs, tvecs = calibrate.calibrateCamera(input_files, output_dir)
