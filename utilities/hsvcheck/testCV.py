...
cv2.resizeWindow('image', 832,600)
...
while(1):
    ...
    if not circles is None:
        ...
        for ( x, y, r) in circles:
            ...
            cv2.circle(result, (int(x[0]), int(x[1])), x[2], (0, 255, 0), 4)
            cv2.circle(result, (int(y[0]), int(y[1])), y[2], (0, 255, 0), 4)
            cv2.circle(result, (int(r[0]), int(r[2])), r[2], (0, 255, 0), 4)
            # cv2.rectangle(result, (int(x[0] - 5), int(y[0] - 5)), (int(x[0] + 5), int(y[0] + 5)), (0, 128, 255), -1)
